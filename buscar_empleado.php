...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-primary topbar mb-3 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <!--Search-->
                        <form action="buscar_empleado.php"
          ...
          $registros = mysqli_query($conexion, "SELECT * FROM empleado WHERE nom_emp = '$nom'") or
          ...
          if($data = mysqli_fetch_array($registros))
          {
            ?>
                                        <tr>
                                            <td>
                                                <?php echo $data['nom_emp']?>
                                            </td>
                                            <td>
                                                <?php echo $data['ape_emp']?>
                                            </td>
                                            <td>
                                                <?php echo $data['tel_emp']?>
                                            </td>
                                            <td>
                                                <?php echo $data['cod_emp']?>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <center><a class="link_delete"
                                                        href="eliminar_empleado.php?cod=<?php echo $data["cod_emp"];
                                                        ?>">
                                                    ...
                                                    <a class="link_update"
                                                        href="form_actualizar_emp.php?cod=<?php echo $data["cod_emp"];
                                                        ?>">
