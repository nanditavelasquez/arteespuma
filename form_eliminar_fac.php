...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        $result = mysqli_query($con, "SELECT * FROM factura WHERE n_factu = '$factu'") or
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title display-6 text-dark">¿ESTA SEGURO DE ELIMINAR ESTE REGISTRO?</h3>
                                </div>
                                <div class="card-body">
                                    <form method="POST" action="eliminar_factura.php?fac='.$field0name.'">
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                <label>Numero factura</label>
                                                <input value="'.$field0name.'" class="form-control" name="fac"
                                                    id="n_factu">
                                            </div>
                                            <div class="form-group col-md-4">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <a class="link_delete" href="mostrar_factura.php">
                                            <input type="button" style="position:relative;top:45%;" 
                                               value="Cancelar"
                                        </a>
                                            <input type="submit" style="position:relative;top:45%;margin-left:2px" 
                                                value="Eliminar">
                                        </diV
                                        </form>
                                    </div>
