...
if($_SERVER['REQUEST_METHOD'] == 'POST')
    {
        ...
        $sql="INSERT INTO factura(n_factu,cod_prov,marca,fecha_factu,id_cli,cantidad,precio,iva,total) 
        VALUES ('$fac','$cod','$marca','$fecha','$id','$can','$precio','$iva','$total')";
                ...
                <nav class="navbar navbar-expand navbar-light bg-primary topbar mb-3 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item mostrar">
                            <a class="nav-link" href="mostrar_factura.php">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title display-6 text-dark">REGISTRAR FACTURA</h3>
                                </div>
                                <div class="card-body">
                                    <form method="POST" action="">
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="number" class="form-control" name="fac" autocomplete="off">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label>Codigo proveedor</label>
                                                <input type="number" class="form-control" name="cod" autocomplete="off">
                                            </div>
                                            <div class="form-group col-md-4">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col md-1">
                                            ...
                                            <input type="number" class="form-control" name="can" id="can"
                                                autocomplete="off">
                                        </div>
                                        <div class="form-group col md-1">
                                            <label>Precio</label>
