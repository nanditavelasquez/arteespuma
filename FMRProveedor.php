...
if($_SERVER['REQUEST_METHOD'] == 'POST')
    {
        ...
        $sql="INSERT INTO proveedor(cod_prov,cod_prod,email,tel_prov) 
        VALUES ('$cod','$codpd','$ema','$tel')";
                ...
                <nav class="navbar navbar-expand navbar-light bg-primary topbar mb-3 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item mostrar">
                            <a class="nav-link" href="mostrar_proveedor.php">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title display-6 text-dark">REGISTRAR PROVEEDOR</h3>
                                </div>
                                <div class="card-body">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="number" class="form-control" name="codpd"
                                                autocomplete="off">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label>Email</label>
