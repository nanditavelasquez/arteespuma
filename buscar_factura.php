...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-primary topbar mb-3 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <!--Search-->
                        <form action="buscar_factura.php"
                            class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                            <div class="input-group">
                                <input type="text" class="form-control bg-ligth border-0 small" name="marca"
          ...
          $registros = mysqli_query($conexion, "SELECT * FROM factura WHERE marca = '$marca'") or
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center><a class="link_delete"
                                                        href="eliminar_factura.php?nfac=<?php echo $data["n_factu"]; ?>">
                                                    ...
                                                    <a class="link_update"
                                                        href="form_actualizar_fac.php?fac=<?php echo $data["n_factu"]; ?>">
