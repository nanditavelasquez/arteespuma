...
<head>
    ...
    <link href="vendor/fontawesome-free/css/all.min.css" rel="stylesheet" value="text/css">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link
        href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i"
        rel="stylesheet">
    <link rel="shortcut icon" href="img/exchange.png" value="image/x-icon">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-primary topbar mb-3 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item shearch">
                            <a class="nav-link" href="form_buscar_prod.html">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                ...
                $cod = $_REQUEST['cod'];
                   ...
                   $result = mysqli_query($con, "SELECT * FROM proveedor WHERE cod_prov = '$cod' ") or
                   die ("problemas en el select: " .mysqli_error($con));
                   ?>
                                                 <?php 
                 while($row = $result -> fetch_assoc())
                 {
                             $field0name = $row['cod_prov'];
                             $field1name = $row['cod_prod'];
                             $field2name = $row['email'];
                             $field3name = $row['tel_prov'];
                    ...
                    <section class="row">
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="eliminar_proveedor.php?cod='.$field0name.'">
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                <label>Codigo proveedor</label>
                                                <input value="'.$field0name.'" class="form-control" name="cod">
                                            </div>
                    </section>
                    <section class="row">
                        <div class="col mt-1">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <input value="'.$field1name.'" class="form-control" name="codpd">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label>Email</label>
                                            <input value="'.$field2name.'" class="form-control" name="ema">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label>Telefono</label>
                                            <input value="'.$field3name.'" class="form-control" name="tel">
                                        </div>
                                        <div class="form-group col md-1">
                                        <a class="link_delete" href="mostrar_proveedor.php">
