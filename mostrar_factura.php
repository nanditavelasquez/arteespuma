                        ...
                        <li class="nav-item register">
                            <a class="nav-link" href="FMRFactura.php">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                                    class="bi bi-person- text-gray-600" viewBox="0 0 16 16">
                                    <path
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="table responsive">
                                <table id="tablaFactura" class="table table-striped table-bordered thead-condensed"
                                    style="width: 100%;">
                        ...
                        ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                href="form_eliminar_fac.php?fac=<?php echo $data["n_factu"];
                                                ?>">
