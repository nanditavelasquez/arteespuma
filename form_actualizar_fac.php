                        ...
                        <li class="nav-item register">
                            <a class="nav-link" href="FMRFactura.php">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                                    class="bi bi-person-plus text-gray-600" viewBox="0 0 16 16">
                                    <path
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col md-1">
                                            <input type="button" style="position:relative;top:30%;left:68px;"
                                                value="Calcular" onclick="calcularTotal()">
                                            <input type="submit" style="position:relative;top:32%;right:9px;" 
                                                value="Actualizar">
                                        <a class="link_delete" href="mostrar_factura.php">
                                                <input type="button" style="position:relative;top:-36%;right:10px;" 
                                                 value="Cancelar"
                                        </a>
                                </diV
                                        </div>
