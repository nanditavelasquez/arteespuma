    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Topbar -->
                <nav class="navbar navbar-expand navbar-light bg-primary topbar mb-3 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item shearch">
                            <a class="nav-link" href="form_buscar_fac.html">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
       ...
       $fac = $_REQUEST['fac'];
          ...
          $result = mysqli_query($con, "SELECT * FROM factura WHERE n_factu = '$fac'") or
          die ("problemas en el select: " .mysqli_error($con));
          ?>
                <?php 
        while($row = $result -> fetch_assoc())
        {
                    $field0name = $row['n_factu'];
                    $field1name = $row['cod_prov'];
                    $field2name = $row['marca'];
                    $field3name = $row['fecha_factu'];
                    $field4name = $row['id_cli'];
                    $field5name = $row['cantidad'];
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title display-6 text-dark">ACTUALIZAR FACTURA</h3>
                                </div>
                                <div class="card-body">
                                    <form method="POST" action="actualizar_factura.php?n_factu='.$field0name.'">
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                <label>Numero factura</label>
                                                <input value="'.$field0name.'" class="form-control" name="fact"
                                                    id="n_factu">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label>Codigo proveedor</label>
                                                <input value="'.$field1name.'" class="form-control" name="cod"
                                                    id="cod_prov">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label>Marca</label>
                                                <input value="'.$field2name.'" class="form-control" name="marca"
                                                    id="marca">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label>Fecha</label>
                                                 &nbsp; &nbsp; &nbsp; 
                                                <input value="'.$field3name.'"class="form-control" name="fecha"
                                                placeholder="0000-00-00">
                                            </div>
                                            <div class="form-group col-md-8">
                                                <label>Id Cliente</label>
                                                <input value="'.$field4name.'" class="form-control" name="id"
                                                    id="id">
                                            </div>
                    </section>
                    <section class="row">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col md-1">
                                            ...
                                            <input value="'.$field5name.'" class="form-control" name="can" id="can">
                                        </div>
                                        <div class="form-group col md-1">
                                            <label>Precio</label>
                                            <input value="'.$field6name.'" class="form-control" name="precio" id="precio">
                                        </div>
                                        <div class="form-group col md-1">
                                            <label>Iva</label>
                                            <input value="'.$field7name.'" class="form-control" name="iva" id="iva"
                                                id="19%">
                                        </div>
                                        <div class="form-group col md-1">
                                            <label for="lbltotal">Total</label>
                                            <input value="'.$field8name.'" class="form-control" name="total" id="total"
                                                id="0">
                                        </div>
                                        <div class="form-group col md-1">
                                            <input type="button" style="position:relative;top:25%;"
                                                value="Calcular" onclick="calcularTotal()">
                                            <input type="submit" style="position:relative;top:80%;margin-left:2px" 
                                                value="Actualizar">
                                        <a class="link_delete" href="mostrar_factura.php">
                                                <input type="button" style="position:relative;top:30%;" 
                                                 value="Cancelar"
                                        </a>
                                </diV
                                        </div>
...
?>
                ...
                <script>
                    ...
                    function calcularTotal() {
                        ...
                        document.getElementById('total').value = cant * precio * 0.19;
