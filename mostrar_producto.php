            ...
            <li class="nav-item">
                ...
                <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="buscar_factura.php">Buscar Factura</a>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="table responsive">
                                <table id="tablaProducto" class="table table-striped table-bordered thead-condensed"
                                    style="width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center><a class="link_delete"
                                                        href="form_eliminar_prod.php?cod=<?php echo $data["cod_prod"];
                                                        ?>">
                                                    ...
                                                    <a class="link_update"
                                                        href="form_actualizar_prod.php?cod=<?php echo $data["cod_prod"]; ?>">
