...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                ...
                <nav class="navbar navbar-expand navbar-light bg-primary topbar mb-3 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item shearch">
                            <a class="nav-link" href="form_buscar_cli.html">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
          ...
          $result = mysqli_query($con, "SELECT * FROM cliente WHERE id_cli = '$id'") or
          die ("problemas en el select: " .mysqli_error($con));
          ?>
                <?php 
        while($row = $result -> fetch_assoc())
        {
                    $field0name = $row['id_cli'];
                    $field1name = $row['cod_prod'];
                    $field2name = $row['nom_cli'];
                    $field3name = $row['ape_cli'];
                    $field4name = $row['localidad'];
                    $field5name = $row['dire_cli'];
                ...
                <section class="row">
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="POST" action="eliminar_cliente.php?id_cli='.$field0name.'">
                                    <div class="row">
                                        <div class="form-group col-md-4" style="text-align:left;">
                                            <label>Id Cliente</label>
                                            <input value="'.$field0name.'" class="form-control" name="id" id="id_cli">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label>Codigo Producto</label>
                                            <input value="'.$field1name.'" class="form-control" name="cod" id="cod_prod">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label>Nombre</label>
                                            <input value="'.$field2name.'" class="form-control" name="nom" id="nom_cli">
                                        </div>
                                        <div class="form-group col-md-8">
                                            <label>Apellido</label>
                                            <input value="'.$field3name.'" class="form-control" name="ape" id="ape_cli">
                                        </div>
                </section>
                <section class="row">
                    <div class="col mt-1">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col md-1">
                                        ...
                                        <input value="'.$field4name.'" class="form-control" name="loca" id="localidad">
                                    </div>
                                    <div class="form-group col md-1">
                                        <label>Direccion</label>
                                        <input value="'.$field5name.'" class="form-control" name="dire" id="dire_cli">
                                    </div>
                                    <div class="form-group col md-1">
                                    <a class="link_delete" href="mostrar_cliente.php">
                                        <input type="button" style="position:relative;top:50%;" value="Cancelar"> 
                                    </a>
                                    <input type="submit" style="position:relative;top:50%;" 
                                        value="Eliminar">
                                    </div>
                                    </div>
                                    </form>
