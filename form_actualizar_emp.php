...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="indexphp">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                  ...
                  <li class="nav-item register">
                        ...
                        <li class="nav-item shearch">
                            <a class="nav-link" href="form_buscar_emp.html">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
        ...
        $cod = $_REQUEST['cod'];
          ...
          $result = mysqli_query($con, "SELECT * FROM empleado WHERE cod_emp = '$cod'") or
          die ("problemas en el select: " .mysqli_error($con));
          ?>
                                        <?php 
        while($row = $result -> fetch_assoc())
        {
                    $field0name = $row['cod_emp'];
                    $field1name = $row['id_cli'];
                    $field2name = $row['nom_emp'];
                    $field3name = $row['ape_emp'];
                    $field4name = $row['tel_emp'];
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title display-6 text-dark">ACTUALIZAR EMPLEADO</h3>
                                </div>
                                <div class="card-body">
                                    <form method="GET" action="actualizar_empleado.php?cod_emp='.$field0name.'">
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                <label">Codigo empleado</label>
                                                <input value="'.$field0name.'" class="form-control" name="cod" id="cod_emp">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Id cliente</label>
                                                <input value="'.$field1name.'" class="form-control" name="id"
                                                    id= "id_cli">
                                            </div>
                    </section>
                    <section class="row">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            <label>Nombre</label>
                                            <input value="'.$field2name.'" class="form-control" name="nom"
                                                id="nom_emp">
                                        </div>
                                        <div class="form-group col md-1">
                                            <label>Apellido</label>
                                            <input value="'.$field3name.'" class="form-control" name="ape"
                                            id="ape_emp">
                                        </div>
                                        <div class="form-group col md-1">
                                            <label>Telefono</label>
                                            <input value="'.$field4name.'" class="form-control" name="tel"
                                                id="tel_emp">
                                        </div>
                                        <div class="form-group col md-1">
                                        <a class="link_delete" href="mostrar_empleado.php">
                                            <input type="button" style="position:relative;top:40%;right:3px;" value="Cancelar"> 
                                        </a>
                                            <input type="submit" style="position:relative;top:-9%;left:75px;" 
                                              value="Actualizar">
                                        </div>
                                        </form>
                                    </div>
