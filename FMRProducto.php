...
if($_SERVER['REQUEST_METHOD'] == 'POST')
    {
        ...
        $sql="INSERT INTO producto(cod_prod,marca,web_oficial,precio) 
        VALUES ('$cod','$marca','$web','$precio')";
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item mostrar">
                            <a class="nav-link" href="mostrar_producto.php">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title display-6 text-dark">REGISTRAR PRODUCTO</h3>
                                </div>
                                <div class="card-body">
