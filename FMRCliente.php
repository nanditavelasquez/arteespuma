<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST')
    {
        ...
        $sql="INSERT INTO cliente(id_cli,cod_prod,nom_cli,ape_cli,localidad,dire_cli) 
        VALUES ('$id','$cod','$nom','$ape','$loca','$dire')";
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item mostrar">
                            <a class="nav-link" href="mostrar_cliente.php">
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title display-6 text-dark">REGISTRAR CLIENTE</h3>
                            </div>
                            <div class="card-body">
                                <form method="POST" action="">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-8">
                                            ...
                                            <input type="" class="form-control" name="ape"
                                                autocomplete="off">
                                        </div>
                </section>
                <section class="row">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col md-1">
                                        ...
                                        <input type="text" class="form-control" name="loca"
                                        autocomple="off">
                                    </div>
                                    <div class="form-group col md-1">
