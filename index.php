...
$consulta = "SELECT COUNT(*) AS total_registros FROM cliente";
...
// Consulta para contar registros
$consulta = "SELECT COUNT(*) AS registroE FROM empleado";
$resultado = mysqli_query($con, $consulta);

// Obtener la cantidad de registros
$fila = mysqli_fetch_assoc($resultado);
$registroE = $fila['registroE'];

// Consulta para contar registros
$consulta = "SELECT COUNT(*) AS registroPD FROM producto";
$resultado = mysqli_query($con, $consulta);

// Obtener la cantidad de registros
$fila = mysqli_fetch_assoc($resultado);
$registroPD = $fila['registroPD'];

// Consulta para contar registros
$consulta = "SELECT COUNT(*) AS registroPV FROM proveedor";
$resultado = mysqli_query($con, $consulta);

// Obtener la cantidad de registros
$fila = mysqli_fetch_assoc($resultado);
$registroPV = $fila['registroPV'];

// Consulta para contar registros
$consulta = "SELECT COUNT(*) AS registroFC FROM factura";
$resultado = mysqli_query($con, $consulta);

// Obtener la cantidad de registros
$fila = mysqli_fetch_assoc($resultado);
$registroFC = $fila['registroFC'];
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600">Colombia, <?php echo fechaC(); ?>
                                </span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-md-4 mb-2">
                            <div class="card border-left-danger shadow h-100 py-2">
                                <a class="nav-link" href="FMREmpleado.php">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">
                                                    Empleado</div>
                                                <p id="registro_empleado"></p>
                                                <script>
                                                    document.getElementById('registro_empleado').innerHTML = <?php echo $registroE; ?>;
                                                </script>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"></div>
                                            </div>
                                            <div class="col-auto">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                                    fill="currentColor" class="bi bi-person-fill text-gray-500"
                                                    viewBox="0 0 16 16">
                                                    <path
                        ...
                        <div class="col-xl-4 col-md-4 mb-2">
                            <div class="card border-left-primary shadow h-100 py-2">
                                <a class="nav-link" href="FMRCliente.php">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                    Cliente</div>
                                                <p id="contador-registros"></p>
                                                <script>
                                                    document.getElementById('contador-registros').innerHTML = <?php echo $totalRegistros; ?>;
                                                </script>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"></div>
                                            </div>
                                            <div class="col-auto">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                                    fill="currentColor" class="bi bi-people-fill text-gray-500"
                                                    viewBox="0 0 16 16">
                                                    <path
                        ...
                        <div class="col-xl-4 col-md-4 mb-2">
                            <div class="card border-left-success shadow h-100 py-2">
                                <a class="nav-link" href="FMRProducto.php">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                    Producto</div>
                                                <p id="registro_producto"></p>
                                                <script>
                                                    document.getElementById('registro_producto').innerHTML = <?php echo $registroPD; ?>;
                                                </script>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"></div>
                                            </div>
                                            <div class="col-auto">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                                    fill="currentColor" class="bi bi-cart4 text-gray-500"
                                                    viewBox="0 0 16 16">
                                                    <path
                                                        d="M0 2.5A.5.5 0 0 1 .5 2H2a.5.5 0 0 1 .485.379L2.89 4H14.5a.5.5 0 0 1 .485.621l-1.5 6A.5.5 0 0 1 13 11H4a.5.5 0 0 1-.485-.379L1.61 3H.5a.5.5 0 0 1-.5-.5zM3.14 5l.5 2H5V5H3.14zM6 5v2h2V5H6zm3 0v2h2V5H9zm3 0v2h1.36l.5-2H12zm1.11 3H12v2h.61l.5-2zM11 8H9v2h2V8zM8 8H6v2h2V8zM5 8H3.89l.5 2H5V8zm0 5a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0zm9-1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0z" />
                                                </svg>
                        ...
                        <div class="col-xl-6 col-md-6 mb-2">
                            <div class="card border-left-info shadow h-100 py-2">
                                <a class="nav-link" href="FMRProveedor.php">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <p id="registro_proveedor"></p>
                                                <script>
                                                    document.getElementById('registro_proveedor').innerHTML = <?php echo $registroPV; ?>;
                                                </script>
                                                <div class="row no-gutters align-items-center">
                                                    <div class="col-auto">
                                                    </div>
                                            ...
                                            <div class="col-auto">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                                    fill="currentColor" class="bi bi-person text-gray-500"
                                                    viewBox="0 0 16 16">
                                                    <path
                                                        d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z" />
                                                </svg>
                        ...
                        <div class="col-xl-6 col-md-6 mb-2">
                            <div class="card border-left-warning shadow h-100 py-2">
                                <a class="nav-link" href="FMRFactura.php">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                    Factura</div>
                                                <p id="registro_factura"></p>
                                                <script>
                                                    document.getElementById('registro_factura').innerHTML = <?php echo $registroFC; ?>;
                                                </script>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"></div>
                                            </div>
                                            <div class="col-auto">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                                    fill="currentColor" class="bi bi-receipt text-gray-500"
                                                    viewBox="0 0 16 16">
                                                    <path
                                                        d="M1.92.506a.5.5 0 0 1 .434.14L3 1.293l.646-.647a.5.5 0 0 1 .708 0L5 1.293l.646-.647a.5.5 0 0 1 .708 0L7 1.293l.646-.647a.5.5 0 0 1 .708 0L9 1.293l.646-.647a.5.5 0 0 1 .708 0l.646.647.646-.647a.5.5 0 0 1 .708 0l.646.647.646-.647a.5.5 0 0 1 .801.13l.5 1A.5.5 0 0 1 15 2v12a.5.5 0 0 1-.053.224l-.5 1a.5.5 0 0 1-.8.13L13 14.707l-.646.647a.5.5 0 0 1-.708 0L11 14.707l-.646.647a.5.5 0 0 1-.708 0L9 14.707l-.646.647a.5.5 0 0 1-.708 0L7 14.707l-.646.647a.5.5 0 0 1-.708 0L5 14.707l-.646.647a.5.5 0 0 1-.708 0L3 14.707l-.646.647a.5.5 0 0 1-.801-.13l-.5-1A.5.5 0 0 1 1 14V2a.5.5 0 0 1 .053-.224l.5-1a.5.5 0 0 1 .367-.27zm.217 1.338L2 2.118v11.764l.137.274.51-.51a.5.5 0 0 1 .707 0l.646.647.646-.646a.5.5 0 0 1 .708 0l.646.646.646-.646a.5.5 0 0 1 .708 0l.646.646.646-.646a.5.5 0 0 1 .708 0l.646.646.646-.646a.5.5 0 0 1 .708 0l.646.646.646-.646a.5.5 0 0 1 .708 0l.509.509.137-.274V2.118l-.137-.274-.51.51a.5.5 0 0 1-.707 0L12 1.707l-.646.647a.5.5 0 0 1-.708 0L10 1.707l-.646.647a.5.5 0 0 1-.708 0L8 1.707l-.646.647a.5.5 0 0 1-.708 0L6 1.707l-.646.647a.5.5 0 0 1-.708 0L4 1.707l-.646.647a.5.5 0 0 1-.708 0l-.509-.51z" />
                                                    <path
                    ...
                    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">Seleccione "Salir" a continuación si está listo para finalizar
