                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title display-6 text-dark">ACTUALIZAR CLIENTE</h3>
                            </div>
                            <div class="card-body">
                                <form method="POST" action="actualizar_cliente.php?id_cli='.$field0name.'">
                                    <div class="row">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <a class="link_delete" href="mostrar_cliente.php">
                                        <input type="button" style="position:relative;top:50%;" 
                                             value="Cancelar"
                                    </a>
