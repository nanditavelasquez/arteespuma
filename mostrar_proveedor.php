                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item shearch">
                            <a class="nav-link" href="form_buscar_prov.html">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="table responsive">
                                <table id="tablaProveedor" class="table table-striped table-bordered thead-condensed"
                                    style="width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center><a class="link_delete"
                                                        href="form_eliminar_prov.php?cod=<?php echo $data["cod_prov"];
                                                        ?>">
