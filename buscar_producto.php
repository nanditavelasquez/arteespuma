...
<body id="page-top">
    ...
    <div id="wrapper">
            ...
            <li class="nav-item">
                ...
                <div id="collapseone" class="collapse" aria-labelledby="headingTree" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="form_buscar_prod.html">Buscar Empleado</a>
                        <a class="collapse-item" href="mostrar_producto.php">Mostrar Empleado</a>
                        <a class="collapse-item" href="form_actualizar_prod.php">Actualizar Empleado</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-primary topbar mb-3 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <!--Search-->
                        <form action="buscar_producto.php"
                            class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                            <div class="input-group">
                                <input type="text" class="form-control bg-ligth border-0 small" name="txtmarca"
          ...
          $registros = mysqli_query($conexion, "SELECT * FROM producto WHERE marca LIKE '%$mar%'") or
          ...
          if($data = mysqli_fetch_array($registros))
          {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center><a class="link_delete"
                                                        href="eliminar_producto.php?codpd=<?php echo $data["cod_prod"];
                                                        ?>">
                                                    ...
                                                    <a class="link_update"
                                                        href="form_actualizar_prod.php?codpd=<?php echo $data["cod_prod"]; ?>">
            ...
            else
            {
                ...
                Error, la marca ingresada del producto no existe.
                </div>";
            }
