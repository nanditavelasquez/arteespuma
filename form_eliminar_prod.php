        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                $cod = $_REQUEST['cod'];
                   ...
                   $result = mysqli_query($con, "SELECT * FROM producto WHERE cod_prod = '$cod'") or
                   die ("problemas en el select: " .mysqli_error($con));
                   ?>
                                                 <?php 
                 while($row = $result -> fetch_assoc())
                 {
                             $field0name = $row['cod_prod'];
                             $field1name = $row['marca'];
                             $field2name = $row['web_oficial'];
                    ...
                    <section class="row">
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="GET" action="eliminar_producto.php?cod_prod='.$field0name.'">
                                        <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-md-3">
                                            <label>Marca</label>
                                            <input value="'.$field1name.'" class="form-control" name="marca">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="lblweb">Web oficial</label>
                                            <input value="'.$field2name.'" class="form-control" name="webof">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="lblweb">Precio</label>
                                            <input value="'.$field3name.'" class="form-control" name="precio">
                                        </div>
                                        <div class="form-group col md-1">
                                        <a class="link_delete" href="mostrar_producto.php">
