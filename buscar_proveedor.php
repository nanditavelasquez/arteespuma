...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseone" class="collapse" aria-labelledby="headingTree" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="FMREmpleado.html">Registrar Empleado</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Componentes:</h6>
                        <a class="collapse-item" href="FMRCliente.html">Registrar Cliente</a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities"
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Componentes:</h6>
                            <a class="collapse-item" href="FMRProducto.html">Registrar Producto</a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages"
                    ...
                    <div id="collapsePages" class="collapse" aria-labelledby="headingPages"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Componentes:</h6>
                            <a class="collapse-item" href="FMRProveedor.html">Registrar Proveedor</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Componentes:</h6>
                        <a class="collapse-item" href="FMRFactura.html">Registrar Factura</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-primary topbar mb-3 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <!--Search-->
                        <form action="buscar_proveedor.php"
                            class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                            <div class="input-group">
                                <input type="text" class="form-control bg-ligth border-0 small" name="txtcodpv"
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="table responsive">
                                <table id="tablaPersonas" class="table table-striped table-bordered thead-condensed"
                                    style="width: 100%;">
          ...
          $registros = mysqli_query($conexion, "SELECT * FROM proveedor WHERE cod_prov = '$cod'") or
          die ("problemas en el select: " .mysqli_error($conexion));

          ?>
                                        <?php 
          if($data = mysqli_fetch_array($registros))
          {
            ?>
                                        <tr>
                                        <td>
                                                <?php echo $data['cod_prov']?>
                                            </td>
                                            <td>
                                                <?php echo $data['cod_prod']?>
                                            </td>
                                            <td>
                                                <?php echo $data['email']?>
                                            </td>
                                            <td>
                                                <?php echo $data['tel_prov']?>
                                            </td>
                                            <td>
                                                <center><a class="link_delete"
                                                        href="eliminar_proveedor.php?codpv=<?php echo $data["cod_prov"];
                                                        ?>">
                                                        <button type='button' class='btn btn-danger btn-sm active'><svg
                                                                xmlns="http://www.w3.org/2000/svg" width="16"
                                                                height="16" fill="currentColor" class="bi bi-eraser"
                                                                viewBox="0 0 16 16">
                                                                <path
                                                    ...
                                                    <a class="link_update"
                                                        href="form_actualizar_prov.php?cod=<?php echo $data["cod_prov"]; ?>">
                                                                <button type='button' class='btn btn-primary btn-sm active'><svg
                                                                        xmlns="http://www.w3.org/2000/svg" width="16"
            ...
            {
                echo "<div class='alert alert-danger content' role='alert'>
