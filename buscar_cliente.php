...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-primary topbar mb-3 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <!--Search-->
                        <form action="buscar_cliente.php"
                            class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                            <div class="input-group">
                                <input type="text" class="form-control bg-ligth border-0 small" name="txtnom"
          ...
          $conexion = mysqli_connect("localhost", "root", "", "cerveceria") or die ("problemas de conexion");
                              
          $nom = $_REQUEST['nom'];

          $registros = mysqli_query($conexion, "SELECT * FROM cliente WHERE nom_cli = '$nom'") or
          ...
          if($data = mysqli_fetch_array($registros))
          {
            ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo $data['dire_cli']?>
                                            </td>
                                            <td>
                                                <center>
                                                    <a class="link_delete"
                                                        href="eliminar_cliente.php?id=<?php echo $data["id_cli"]; ?>">
                                                    ...
                                                    <a class="link_update"
                                                        href="form_actualizar_cli.php?id=<?php echo $data["id_cli"];?>">
